...
export const customerSignUp = createAsyncThunk(
  ...
  async (customer) => {
    ...
    const response = await axios.post("http://localhost:5000/api/customer/register",customer);
...
export const depositeAmount = createAsyncThunk(
    ...
    async (customer) => {
      console.log(customer);
      //const response = await axios.put(`http://localhost:3000/customers/${customer.id}`,customer);
      const response = await axios.put(`http://localhost:5000/api/customer/depositAmount`,customer);
      console.log(response.data);
      return response.data;
    }
);
